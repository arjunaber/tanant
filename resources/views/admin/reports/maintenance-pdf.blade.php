...
<head>
    ...
    <title>Laporan Unit Maintenance</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>LAPORAN UNIT MAINTENANCE</h1>
    ...
    @if($units->count() > 0)
        ...
        <div style="margin-top: 20px; padding: 10px; background-color: #f9f9f9; border: 1px solid #ddd;">
            <strong>Ringkasan Unit Maintenance:</strong><br>
            Total Unit dalam Maintenance: {{ $units->count() }}<br>
            Perlu segera diperbaiki untuk mengoptimalkan pendapatan.
        </div>
    @else
        <div class="no-data">
            Tidak ada unit yang sedang dalam maintenance.
        </div>
    @endif
