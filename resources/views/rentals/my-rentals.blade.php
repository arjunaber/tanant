            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <p class="mt-6 text-gray-500 leading-relaxed">
                        Kelola semua peminjaman ruangan Anda di sini. Lihat status, detail, dan riwayat peminjaman.
                    </p>
                </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $rental->unit->name }}</div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            ...
                                            <div class="text-xs">s/d {{ \Carbon\Carbon::parse($rental->end_date)->format('d/m/Y') }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    @else
                        <div class="px-6 py-12 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Anda belum melakukan peminjaman ruangan apapun.
                            </p>
                            <div class="mt-6">
                               <a href="{{ url('/units') }}"
