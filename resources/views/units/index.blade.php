                ...
                <div class="flex-1">
                    ...
                    <div class="flex-1">
                        ...
                        <select name="status" id="status"
                            ...
                            <option value="occupied" {{ request('status') == 'occupied' ? 'selected' : '' }}>Ditempati
                            </option>
                    ...
                    <div class="flex-1">
                        ...
                        <select name="sort" id="sort"
                            ...
                            <option value="price_desc" {{ request('sort') == 'price_desc' ? 'selected' : '' }}>Harga
                                Tertinggi</option>
                            <option value="capacity" {{ request('sort') == 'capacity' ? 'selected' : '' }}>Kapasitas
                                Terkecil</option>
                        </select>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchResults.className =
                'absolute z-10 w-full bg-white border border-gray-300 rounded-md mt-1 shadow-lg hidden';
                ...
                fetch(`{{ route('units.search.ajax') }}?search=${encodeURIComponent(query)}`)
                    ...
                    `).join('');
                            ...
                            searchResults.innerHTML =
                                '<div class="px-4 py-2 text-gray-500">Tidak ada hasil ditemukan</div>';
                            searchResults.classList.remove('hidden');
                        }
                    });
            });
